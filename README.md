...
### 19.01.2025
+ Метод .reset переименован в .clearParams
+ Добавлена возможность установить модификатор работы пина для увелицения вариаций подключения
+ В метод .setPin и конструктор добавлен аргумент указания константы модификатора пина
